...
- <span style="color: Red;">Compiled Python Files</span>
  ...
  - Python always recompiles the module that we load directly from the command line

- <span style="color: Red;">Module Search Paths</span>

  - When we import a module at start of compiling a py file python look for finding that module in:
  - `A`: The current directory
  - `B`: some predefined directories which come with the python installation
